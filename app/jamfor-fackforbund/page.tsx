...
export const metadata = {
    title: 'Jämför Fackförbund – Hitta rätt fack 2025',
    description: 'Jämför Sveriges alla fackförbund. Se avgifter, medlemsantal och vilka yrken de passar för. LO, TCO och SACO.',
};
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl text-center">
                    ...
                    <p className="mt-2 text-lg leading-8 text-gray-600">
                        Här hittar du en lista över {category ? category : 'alla'} fackförbund i vår databas.
                    </p>
                </div>

                {/* Filters */}
                <div className="mt-10 flex justify-center gap-4 flex-wrap">
                    <Link href="/jamfor-fackforbund" className={`px-4 py-2 rounded-full text-sm font-medium ${!category ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}>
                        Alla
                    </Link>
                    <Link href="/jamfor-fackforbund?cat=LO" className={`px-4 py-2 rounded-full text-sm font-medium ${category === 'LO' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}>
                        LO
                    </Link>
                    <Link href="/jamfor-fackforbund?cat=TCO" className={`px-4 py-2 rounded-full text-sm font-medium ${category === 'TCO' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}>
                        TCO
                    </Link>
                    <Link href="/jamfor-fackforbund?cat=SACO" className={`px-4 py-2 rounded-full text-sm font-medium ${category === 'SACO' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}>
                        SACO
                    </Link>
                </div>
